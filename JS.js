...
$(document).ready(function() {
	var cert = $("#pie");
	var myLineChart = new Chart(cert, {
		type: 'pie',
		data: {
	...
	$("a.sidepanel").click(function() {
		window.location.href="test.html";
		$("#ctitle").text("S1 : Student Journal Pub");
		$('#cdesc').text('Student journals are a collection of students written and illustrated predictions, reactions, understandings and questions based on Perspectives central text read alouds.');
	});
});